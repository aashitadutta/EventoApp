...
import android.widget.Toast;
	...
	public class SignUpActivity extends Activity {
		private static final String usernameEmail = "aashitadutta@gmail.com";
	    private static final String passwordEmail = "amrita12345";
	    String subject = "test";
	    String body = "";
		String usergender="";
		String gender = "";
		...
		protected void onCreate(Bundle savedInstanceState) 
		{
			...
			btnCreateAccount.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					body = "You Have Successfully Signed Up" + " " + "USERNAME = " + userName + " " + "PASSWORD = " + password;	
					...
					/*final Dialog dialog = new Dialog(SignUpActivity.this);
					   ...
					   btn_login.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
						    ...
						    try{  
			                    ...
			                    {  
			                        LoginDataBaseAdapter dbUser = new LoginDataBaseAdapter(SignUpActivity.this);  
			                        dbUser.open();  
					   ...
					   // Toast.makeText(getApplicationContext(), "Login For Authentication ", Toast.LENGTH_LONG).show();
	...
	private boolean isValidEmail(String email) {
		...
		private void sendMail(String email, String subject, String messageBody) {
		 ...
		 private Message createMessage(String email, String subject, String messageBody, Session session) throws MessagingException, UnsupportedEncodingException {
		        ...
		        message.setFrom(new InternetAddress("aashitadutta@gmail.com"));
