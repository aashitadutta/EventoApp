...
public class CustomAdapter extends BaseAdapter{   
 ...
 int [] imageId;
    ...
    public CustomAdapter(SocietyList societyList, String[] societyNameList, int[] societyImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;       
         ...
         break;
      /* case 1 :Intent appInfo = new Intent(context, Iste.class);
            startActivity(appInfo);
         break;
         case 2 :Intent appInfo = new Intent(context, Sae.class);
            startActivity(appInfo);
         break;*/
                }
            }
