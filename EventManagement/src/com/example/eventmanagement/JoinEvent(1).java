...
EditText textUserName,textEventName,textJoinDate,textUserPhone;
Button btnJoin;
...
btnJoin.setOnClickListener(new View.OnClickListener() {
	...
	public void onClick(View v) {
		...
		body = "USERNAME = " + user_name1 + "EVENTNAME = " + event_name1 + "DATE OF JOINING = " + date1 + "CONTACT = " + user_contact;
	...
	if(user_name1.equals("")||event_name1.equals("")||date1.equals("")||user_contact.equals(""))
		...
		{					    // Save the Data in Database
		    dbadapter.userJoin(user_name1,event_name1,date1,user_contact);
