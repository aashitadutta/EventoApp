...
public class LoginDataBaseAdapter {
	...
	static final String JOINT_TABLE = "create table "+"USER_TABLE"+
            "(" +"ID"+" integer primary key autoincrement,"+ "USER_NAME TEXT, USER_EVENT_NAME TEXT, USER_JOIN_DATE DATETIME, USER_PHONE TEXT ); "; 
	...
	public Images retriveImgDetails(String k){
	    Cursor cur = db.query(true, IMAGE_TABLE, new String[] { EVENT_NAME_IMAGE,
	...
	public void userJoin(String user_name,String event_name,String date,String phone){
...
public Cursor getAllUsers() {
	//String where = null;
	Cursor c =db.query(USER_TABLE, new String[] { "rowid _id", USER_NAME, USER_EVENT_NAME, USER_JOIN_DATE }, 
		    null, null, null, null, null);
	if( c!= null) {
		c.moveToFirst();
	}
